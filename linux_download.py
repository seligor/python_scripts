...
def alllinux():
    ...
    debian()
    fedora()
#    rosa()  уж очень зоопарк на сайте. На столько, что не хочется добавлять скачивание. 
#    astra() публичного доступа нет - соответственно и скачивания не будет
    centos()
#    redhat() публичного доступа не нашёл, хотя думаю где-то есть
    alma()
    alt()
    altserver()
    redos()
